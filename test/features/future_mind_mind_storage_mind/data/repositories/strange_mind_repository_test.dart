...
import 'package:fm_rek/features/future_mind_strange_mind/data/repositories/default_strange_mind_repository.dart';
...
@GenerateMocks([StrangeMindRemoteDataSource])
void main() {
  late MockStrangeMindRemoteDataSource mockRemoteDataSource;
  late DefaultStrangeMindRepository repository;

  setUp(() {
    mockRemoteDataSource = MockStrangeMindRemoteDataSource();
    repository = DefaultStrangeMindRepository(mockRemoteDataSource);
  });
