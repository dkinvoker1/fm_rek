...
import 'package:fm_rek/features/future_mind_strange_mind/presentation/pages/strange_mind_list_page/bloc/strange_mind_list_bloc.dart';
...
void main() {
  ...
  void setUpMockLoadUseCaseConnectionFailure() => when(
        ...
        (_) async => const Left(
          FailureAbstract.connectionFailure(),
        ),
      );
