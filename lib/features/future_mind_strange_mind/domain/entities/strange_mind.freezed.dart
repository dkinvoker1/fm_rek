...
class _$_StrangeMindEntity implements _StrangeMindEntity {
  ...
  @override
  String toString() {
    return 'StrangeMindEntity(orderId: $orderId, id: $id, title: $title, description: $description, detailsUrl: $detailsUrl, imageUrl: $imageUrl, modificationDate: $modificationDate)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, orderId, id, title, description,
